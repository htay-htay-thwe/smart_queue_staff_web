  ...
  return (
    <Controller
      ...
      render={({ field: { onChange, value }, fieldState }) => {
        const isLocationSet = value.lat !== center.lat || value.lng !== center.lng;
    ...
    <div className="space-y-6 animate-fade-in-delay-3">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-800">Location</h3>
            <p className="text-sm text-gray-500">Click on the map to pin your location</p>
          </div>
        </div>
      ...
      {/* Map Container */}
      <div className={`relative rounded-2xl overflow-hidden shadow-xl border-2 transition-shadow duration-300 ${
        fieldState.invalid ? 'border-red-300' : 'border-gray-200 hover:shadow-2xl'
      }`}>
        <GoogleMap
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500 mt-1">
              Lat: <span className="font-mono font-semibold">{value.lat.toFixed(6)}</span>,
              Lng: <span className="font-mono font-semibold">{value.lng.toFixed(6)}</span>
            </p>
          </div>
        </div>
      </div>
